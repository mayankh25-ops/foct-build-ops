...
// ---- parse theme blocks -------------------------------------------------
const THEMES = ["graphite", "harbour", "eucalypt", "sandstone", "ink", "option-analytics", "option-blush", "option-slate", "option-sunset", "option-nature", "support", "subzero", "option-halo", "kiosk", "kiosk-night"];
const themes = {};
