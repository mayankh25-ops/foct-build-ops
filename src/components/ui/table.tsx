...
export function Th({
  ...
  return (
    <th
      className={cn(
        "px-4 py-3 text-left text-caption font-medium tracking-wide text-fg-muted uppercase",
        numeric && "text-right",
        className
      )}
      {...props}
...
export function Td({
  ...
  return (
    <td
      className={cn(
        "px-4 py-3 text-body-sm text-fg",
        numeric && "text-right font-mono text-caption",
        className
      )}
      {...props}
    />
