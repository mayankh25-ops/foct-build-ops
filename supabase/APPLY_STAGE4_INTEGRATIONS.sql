-- GENERATED one-paste apply for Stage 4 (integrations) — regenerate with npm run build:apply-stage4
-- Prereqs: APPLY_STAGE2 + APPLY_STAGE3 already applied. Idempotent — safe to re-run.
-- Afterwards run supabase/tests/integrations_isolation_check.sql (expect 19 ok-notices).
-- =============================================================================
