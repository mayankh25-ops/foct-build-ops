-- =============================================================================
-- FOCT BuildingOps — TIMESHEETS APPLY (paste into the Supabase SQL editor and
-- Run). Idempotent — safe to re-run.
--
-- Turns kiosk punches into a payable week: per-session corrections that never
-- edit the original punch, approve / reject / reopen with a reason and a
-- decider, and an approved week that LOCKS against further changes.
--
-- Only needed if you applied APPLY_EVERYTHING.sql before this existed.
-- Afterwards run supabase/tests/timesheet_isolation_check.sql (expect 20 ok).
-- =============================================================================
